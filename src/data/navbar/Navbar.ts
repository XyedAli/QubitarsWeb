...
export const companyData: CompanyDataItem[] = [
  ...
  { type: "companyLink", id: "about-us", label: "About Us", href: "/about-us" },
  { type: "companyLink", id: "success-stories", label: "Success Stories", href: "/case-studies" },
  { type: "companyLink", id: "blogs", label: "Blogs", href: "/blogs" },
  { type: "insideQubitarsLink", id: "life-at-qubitars", label: "Life at Qubitars", href: "/about-us#life-at-qubitars" },
  { type: "careersLink", id: "open-positions", label: "Open Positions", href: "/careers#open-positions" },
  { type: "careersLink", id: "benifits", label: "Benifits", href: "/careers#benifits" },
  { type: "blogPost", id: "blog-1", image: companyCloudinaryImages.blog1, alt: "Blog 1", title: "Adaptive Learning for Neurodivergent Students" },
  { type: "blogPost", id: "blog-2", image: companyCloudinaryImages.blog2, alt: "Blog 2", title: "Adaptive Learning for Neurodivergent Students" },
  { type: "blogPost", id: "blog-3", image: companyCloudinaryImages.blog3, alt: "Blog 3", title: "Adaptive Learning for Neurodivergent Students" },
