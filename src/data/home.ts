...
const heroIconSources = [
  { src: svgIcons.icon, alt: "AI Consultation" },
  { src: svgIcons.icon1, alt: "AI Agent" },
  { src: svgIcons.icon2, alt: "AI Development" },
  { src: svgIcons.icon3, alt: "AI Solutions" },
  { src: svgIcons.icon4, alt: "AI Workflow" },
  { src: svgIcons.icon5, alt: "Web App Development" },
  { src: svgIcons.icon6, alt: "UI/UX Design" },
  { src: svgIcons.icon7, alt: "Software Development" },
  { src: svgIcons.icon10, alt: "Mobile App Development" },
  { src: svgIcons.icon9, alt: "MVP Development" },
  { src: svgIcons.icon8, alt: "SAAS Development" },
  { src: svgIcons.icon11, alt: "Quality Assurance" },
  { src: svgIcons.icon12, alt: "Product Design" },
  { src: svgIcons.icon13, alt: "Low Code/No Code Development" },
  { src: svgIcons.icon14, alt: "DevOps" },
  { src: svgIcons.icon15, alt: "Staff Augmentation" },
];
