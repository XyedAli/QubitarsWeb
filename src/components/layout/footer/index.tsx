...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-[#1E274F] from-0% via-[#1E274F] via-85% to-[#171F3D] relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-start md:justify-between gap-6 mb-6 lg:mb-7">
                <Image
                  src={rootImages.logo2}
                  alt="Qubitars Technologies Logo"
                  width={200}
                  height={50}
                  className="w-auto h-10 md:h-12 lg:h-14 xl:h-16 self-start"
                  unoptimized
                />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-6 xl:gap-8 mb-7">
          ...
          <div className="lg:col-span-6">
            <div className="mb-4 lg:mb-4">
              <h6 className={`${styles.p2} font-bold text-white mb-3`}>Texas</h6>
              ...
              <h6 className={`${styles.p2} text-white font-bold mb-3`}>Gujranwala</h6>
          ...
          <div className="lg:col-span-2 ps-0 lg:ps-3 xl:ps-11">
            <h3 className="text-white font-bold text-lg mb-6 capitalize">Industries</h3>
            <ul className="space-y-3 ">
        ...
        <div className="relative">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6 relative z-10">
            ...
            <div className={combine(styles.flexCenter, "gap-3 lg:gap-4 order-1 md:order-2 mt-4 md:mt-0 self-start md:self-auto")}>
