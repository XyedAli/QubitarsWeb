        ...
        <div className={`relative z-10 bg-[#1E274F] pe-4 md:pe-0 ps-4 xl:ps-10 w-full h-[calc(100vh-135px)]`}>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-9 items-start md:items-center w-full h-full">
            ...
            >
              ...
              {/* Main Heading */}
              <h1 className={`text[30px] md:text-[28px] lg:text-[34px] xl:text-[44px] font-black text-white leading-tight uppercase mb-4`}>
                AI-Powered Ecosystems for<span className="hidden xl:inline"><br /></span> Global Companies
              </h1>

              {/* Description */}
              <p className={`${styles.p2} text-white/90 max-w-sm lg:max-w-lg xl:max-w-2xl leading-relaxed mb-6`}>
