...
import { mythPositions, realityPositions, mythItems, realityItems } from "@/data/digital-transformation/mythVSreality";

const myths = mythItems;
const reality = realityItems;
