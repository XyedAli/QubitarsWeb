        ...
        <div className="overflow-hidden">
          <div className="grid grid-cols-2 gap-4 text-white font-bold">
            ...
            <div className={combine(styles.flexCenter, "relative col-span-2 h-20")}>
              <div className={combine(styles.flexBetween, "bg-gradient-to-r from-[#F05C22] via-[#F58220] to-[#EA4D24] py-1 px-2 rounded-tl-full rounded-bl-full w-1/2")}>
              ...
              <div className={combine(styles.flexBetween, "bg-gradient-to-r from-[#1F274F] via-[#1E274F] to-[#36458A] py-1 px-2 rounded-tr-full rounded-br-full w-1/2")}>
            ...
            {mythsReality.map((item, idx) => (
              <React.Fragment key={idx}>
                <div
                  className={combine(styles.p1, "px-6 py-4 text-blue font-bold border-b border-gray-200 rounded-tl-full rounded-bl-full bg-white h-20 flex items-center justify-center")}>
                  {item.myth}
                </div>
                <div
                  className={combine(styles.p2, "px-14 py-4 text-gray-600 font-normal font-inter border-b border-gray-200 rounded-tr-full rounded-br-full bg-white h-20 flex items-center justify-center text-center")}>
                  {item.reality}
                </div>
              </React.Fragment>
            ))}
