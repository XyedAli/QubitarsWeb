      ...
      <div>
        <div className="relative overflow-hidden rounded-xl bg-[#F2F4FF] min-h-[315px] lg:min-h-[380px] xl:min-h-[420px] px-6 py-12 lg:px-14 lg:py-20 pb-10 md:pb-12">
          <div
            ...
            aria-hidden
          >
            <Image src={assets.stateimg6} alt="Qubitars Technology — business excellence section background pattern" fill sizes="100vw" />
          </div>
          <div
          ...
          >
            <Image
              ...
              alt="Qubitars industry solutions — supporting visual texture"
              fill
